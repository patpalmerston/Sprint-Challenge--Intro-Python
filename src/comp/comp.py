...
mid = set('cdefg')
c = [person.name for person in humans if (person.name[0].lower() in mid)]
print(c)
...
f = [(person.name, person.age) for person in humans if (person.age >= int(27) and person.age <= int(33) )]
print(f)
